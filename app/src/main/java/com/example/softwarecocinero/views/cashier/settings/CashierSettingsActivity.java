package com.example.softwarecocinero.views.cashier.settings;
...
import com.example.softwarecocinero.views.cashier.profile.CashierProfileActivity;
...
public class CashierSettingsActivity extends AppCompatActivity {
    ...
    private LinearLayout btnCashierLogout;
    private RelativeLayout btnBack;
    private LinearLayout btnShowCashierProfile;

    @Override
    protected void onCreate( Bundle savedInstanceState ){
        super.onCreate (savedInstanceState );
        setContentView( R.layout.cashier_settings_activity );

        btnCashierLogout = ( LinearLayout )findViewById( R.id.btnCashierLogout );
        btnCashierLogout.setOnClickListener( new View.OnClickListener(){
        ...
        btnShowCashierProfile = ( LinearLayout )findViewById( R.id.btnShowCashierProfile );
        btnShowCashierProfile.setOnClickListener(new View.OnClickListener(){
    ...
    private void showProfilePanel(){
        Intent intent = new Intent( this, CashierProfileActivity.class );
