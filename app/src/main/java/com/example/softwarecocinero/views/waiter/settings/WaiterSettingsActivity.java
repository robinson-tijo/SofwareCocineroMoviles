package com.example.softwarecocinero.views.waiter.settings;
...
import com.example.softwarecocinero.views.waiter.profile.WaiterProfileActivity;
...
public class WaiterSettingsActivity extends AppCompatActivity {
    ...
    */
    ...
    private LinearLayout btnWaiterLogout;
    private RelativeLayout btnBack;
    private LinearLayout btnShowWaiterProfile;

    @Override
    protected void onCreate( Bundle savedInstanceState ){
        super.onCreate( savedInstanceState );
        setContentView( R.layout.waiter_settings_activity );

        btnWaiterLogout = ( LinearLayout )findViewById( R.id.btnWaiterLogout );
        btnWaiterLogout.setOnClickListener( new View.OnClickListener(){
        ...
        btnShowWaiterProfile = ( LinearLayout )findViewById( R.id.btnShowWaiterProfile );
        btnShowWaiterProfile.setOnClickListener( new View.OnClickListener(){
    ...
    private void showProfilePanel(){
        Intent intent = new Intent( this, WaiterProfileActivity.class );
